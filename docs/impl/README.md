...
| IMPL-0008 | Serve docz yaml key spellings in config snapshot via docz v1.2.2 | Draft | 2026-08-30 | Donald Gifford | [0008-serve-docz-yaml-key-spellings-in-config-snapshot-via-docz-v122.md](0008-serve-docz-yaml-key-spellings-in-config-snapshot-via-docz-v122.md) |
