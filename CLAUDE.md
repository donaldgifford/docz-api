...
Per-repo orientation for `donaldgifford/docz-api`. This file is a
...
- Single binary under `cmd/docz-api/`; library code under
...
- Lives on Forgejo (`github.com/donaldgifford/docz-api`); a
