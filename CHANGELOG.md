...
- *(investigation)* Point INV-0002 and INV-0003 at their docz successors ([#44](https://github.com/donaldgifford/docz-api/issues/44))

## [0.10.1] - 2026-09-20

### Bug Fixes

- *(chart)* Scrape Meilisearch metrics and stop the API monitor selecting it ([#42](https://github.com/donaldgifford/docz-api/issues/42))
...
- *(search)* Timestamped, sortable, source-filterable search hits ([#34](https://github.com/donaldgifford/docz-api/issues/34)) ([#37](https://github.com/donaldgifford/docz-api/issues/37))
...
- *(auth)* Make OIDC scopes configurable, drop groups from the default ([#32](https://github.com/donaldgifford/docz-api/issues/32))
...
- Search source facet + IMPL-0007 close-out (PR-2) ([#24](https://github.com/donaldgifford/docz-api/issues/24))

## [0.7.0] - 2026-08-29

### Features

- Docz v1.2.0 api block — pages through fetch, store, serve, and webhook (IMPL-0007 PR-1) ([#23](https://github.com/donaldgifford/docz-api/issues/23))
...
- Error observability, queue self-heal, and a login-free first-setup mode (INV-0007 / IMPL-0006) ([#19](https://github.com/donaldgifford/docz-api/issues/19))
